...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white text-gray-900 overflow-hidden relative">
      ...
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center text-center pt-40 pb-32 px-6 lg:px-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-100 text-green-700 text-sm mb-6 backdrop-blur-sm border border-green-200">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/about"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-green-400 bg-white text-green-700 hover:bg-green-50 transition-all"
          >
            Learn More
          </Link>
        </div>
      ...
      {/* Our Mission */}
      <section className="relative py-20 px-6 lg:px-12 bg-white text-center">
      ...
      <section className="relative py-20 px-6 lg:px-12 bg-green-50/40">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="group p-10 rounded-3xl bg-white border border-green-100 hover:border-green-400 transition-all hover:shadow-[0_0_35px_-10px_rgba(0,128,0,0.3)] hover:scale-[1.02] duration-300"
            >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <Link
              href={item.link}
              key={i}
              className="group p-8 rounded-3xl bg-green-50 border border-green-100 hover:border-green-400 hover:bg-white transition-all hover:shadow-[0_0_35px_-10px_rgba(0,128,0,0.3)] duration-300"
            >
              <div className="w-12 h-12 rounded-2xl bg-green-100 flex items-center justify-center mb-5 group-hover:bg-green-200 transition-colors">
                {item.icon}
              </div>
      ...
      {/* Trust Section */}
      <section className="relative py-28 px-6 lg:px-12 bg-green-50 text-center">
